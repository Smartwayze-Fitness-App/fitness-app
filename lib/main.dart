...
import 'package:untitled6/login%20page.dart';
import 'package:untitled6/progress_trakerscreen.dart';
import 'package:untitled6/user_profile_screen.dart';
...
class _ReminderScreenState extends State<ReminderScreen> {
  List<Reminder> reminders = [
    Reminder(title: 'Workout Reminder',
        subtitle: 'Time for leg day',
        time: TimeOfDay(hour: 18, minute: 0)),
    Reminder(title: 'Water Reminder',
        subtitle: 'Time to drink water',
        time: TimeOfDay(hour: 14, minute: 0),
        completed: true),
    Reminder(title: 'Meal Reminder',
        subtitle: 'Track your lunch',
            ...
            actions: [
              TextButton(
                onPressed: () {
                  ...
                  _addReminder(titleController.text, subtitleController.text,
                      selectedTime);
                },
                child: Text("Add"),
              )
            ...
            Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text("Today's Reminder", style: TextStyle(fontSize: 26,
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: TextStyle(
                              ...
                              decoration: reminder.completed ? TextDecoration
                    ...
                    Row(
                      children: [
                        Icon(Icons.access_time, size: 18, color: Colors
                            .black54),
                        SizedBox(width: 4),
                        Text(reminder.time.format(context), style: TextStyle(
                            fontSize: 14)),
                        Spacer(),
                        ElevatedButton(
                          onPressed: () => _toggleCompletion(index),
                          style: ElevatedButton.styleFrom(
                            backgroundColor: reminder.completed ? Colors.green
                          ...
                          child: Text(
                            ...
                            style: TextStyle(color: reminder.completed
                                ? Colors.white
                                : Colors.black87),
                          ),
                        ),
